...
function AdminSuggestion({ video, setAdminModal, setAdminModalContent }) {
    ...
    return (
        <div id='suggestion-box-container' dir='rtl' onClick={() => { setAdminModal(false), setAdminModalContent(content) }}>
